...
############################param_set
############################
def initial_cond_generation(param_set):
    """
    ...
    num_init_cond = param_set.num_init_cond
    num_indp_var = param_set.num_indp_var
    min_init_cond = param_set.min_init_cond
    max_init_cond = param_set.max_init_cond
