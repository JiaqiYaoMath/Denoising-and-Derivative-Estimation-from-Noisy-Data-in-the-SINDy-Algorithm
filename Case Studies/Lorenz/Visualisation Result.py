...
#################################################################################################
plt.style.use('seaborn-v0_8-whitegrid')
fig, axes = plt.subplots(2, 6, figsize=(24, 12), subplot_kw={'projection': '3d'})
...
axes[0, 0].set_zlabel(r'State', fontsize=34)
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[0, 0].set_title('Data', fontsize=34)
axes[0, 0].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
...
axes[1, 0].scatter(train_deri2[:,0], train_deri2[:,1], train_deri2[:,2], marker='x', s = 150, color = 'green')
#axes[1, 0].set_ylabel(r'Derivative', fontsize=34)
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 0].tick_params(axis='both', labelsize=24)
...
axes[0, 5].plot(TVR_fun_train[:,0], TVR_fun_train[:,1], filter_fun_train[:,2], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[0, 5].set_title('TVR', fontsize=34)
axes[0, 5].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
...
axes[1, 5].plot(TVR_deri_train[:,0], TVR_deri_train[:,1], filter_deri_train[:,2], linewidth=2, color = 'red',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 5].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
axes[1, 5].xaxis.set_major_locator(MaxNLocator(nbins=3))
...
fig.text(-0.01, 0.75, 'State', fontsize=34, rotation=90, va='center', ha='center')
fig.text(-0.01, 0.30, 'Derivative', fontsize=34, rotation=90, va='center', ha='center')

plt.tight_layout()


plt.savefig("4visualize3.pdf", format="pdf", bbox_inches="tight")
plt.show()