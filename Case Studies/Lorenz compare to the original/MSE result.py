...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x1.pdf', format='pdf')
plt.show()
...
plt.plot(param_set.ts[:index], (train_output[:,0] - TVR_fun_train[:,0]), linewidth=2,linestyle='-',color = 'black', label = r'Runge-Kutta Training')
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x3.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4x3diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx1.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx3.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4dotx3diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx1.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx3.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/4ddotx3diff.pdf', format='pdf')
plt.show()