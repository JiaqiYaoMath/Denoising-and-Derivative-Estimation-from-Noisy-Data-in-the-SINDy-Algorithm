...
if param_set.add_noise:
    u_scaled1, deri_data1 = add_white_noise(u_scaled, deri_data, param_set)
...
plt.plot(param_set.ts[:index], filter_fun_train[:,0], linewidth=2,linestyle='-',color = 'yellow', label = r'Filter')
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1x1.pdf', format='pdf')
plt.show()
...
plt.plot(param_set.ts[:index], torch.abs(train_output[:,0] - filter_fun_train[:,0]), linewidth=2,linestyle='-',color = 'yellow', label = r'Filter')
...
print(np.mean((       (train_output[:,0] - train_output1[:,0])**2    ).numpy()))
print()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1x1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1x2.pdf', format='pdf')
plt.show()
...
print(np.mean((       (train_output[:,1] - train_output1[:,1])**2    ).numpy()))
print()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1x2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1dotx1.pdf', format='pdf')
plt.show()
...
print(np.mean((       (train_deri[:,0] - train_deri1[:,0])**2    ).numpy()))
print()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1dotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1dotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1dotx2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1ddotx1.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1ddotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1ddotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/1ddotx2diff.pdf', format='pdf')
plt.show()
