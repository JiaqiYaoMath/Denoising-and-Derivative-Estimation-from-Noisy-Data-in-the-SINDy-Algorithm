...
plt.plot(param_set.ts[:index], filter_fun_train[:,0], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$S$')
plt.plot(param_set.ts[:index], filter_fun_train[:,1], linewidth=2, color = 'green',linestyle='--', marker='o', label = r'$E$')
plt.plot(param_set.ts[:index], filter_fun_train[:,2], linewidth=2, color = 'red',linestyle='--', marker='o', label = r'$I$')
plt.plot(param_set.ts[:index], filter_fun_train[:,3], linewidth=2, color = 'cyan',linestyle='--', marker='o', label = r'$R$')
...
plt.style.use('seaborn-v0_8-whitegrid')
plt.figure(figsize=(8, 6))
plt.plot(param_set.ts[:index], filter_deri_train[:,0], linewidth=2, color = 'darkblue',linestyle='--', marker='o', label = r'$\dot{S}$')
plt.plot(param_set.ts[:index], filter_deri_train[:,1], linewidth=2, color = 'green',linestyle='--', marker='o', label = r'$\dot{E}$')
plt.plot(param_set.ts[:index], filter_deri_train[:,2], linewidth=2, color = 'red',linestyle='--', marker='o', label = r'$\dot{I}$')
plt.plot(param_set.ts[:index], filter_deri_train[:,3], linewidth=2, color = 'cyan',linestyle='--', marker='o', label = r'$\dot{R}$')
plt.xlabel(r'$t$', fontsize=30)
#plt.ylabel(r'Function $x$', fontsize=22)
plt.legend(fontsize=24)
plt.xticks(fontsize=30)  # 调整 x 轴刻度字体大小
