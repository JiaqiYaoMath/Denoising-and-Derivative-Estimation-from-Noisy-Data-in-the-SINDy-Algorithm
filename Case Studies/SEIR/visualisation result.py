...
plt.savefig("3visualize2.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
axes[0, 0].plot(train_output[:,2], train_output[:,3], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
...
axes[1, 0].plot(train_deri[:,2], train_deri[:,3], linewidth=2, color = 'red',linestyle='--', marker='o', label = r'$\dot{x}_1$')
axes[1, 0].set_ylabel(r'Derivative', fontsize=34)
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 0].tick_params(axis='both', labelsize=24)
...
axes[0, 1].plot(prediction_train3[:,2], prediction_train3[:,3], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
...
axes[1, 1].plot(deri_train3[:,2], deri_train3[:,3], linewidth=2, color = 'red',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 1].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
axes[1, 1].xaxis.set_major_locator(MaxNLocator(nbins=3))
...
axes[0, 2].plot(prediction_train1[:,2], prediction_train1[:,3], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[0, 2].set_title('Sobolev', fontsize=34)
axes[0, 2].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
...
axes[1, 2].plot(deri_train1[:,2], deri_train1[:,3], linewidth=2, color = 'red',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 2].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
axes[1, 2].xaxis.set_major_locator(MaxNLocator(nbins=3))
...
axes[0, 3].plot(prediction_train2[:,2], prediction_train2[:,3], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[0, 3].set_title('Runge-Kutta', fontsize=34)
axes[0, 3].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
...
axes[1, 3].plot(deri_train2[:,2], deri_train2[:,3], linewidth=2, color = 'red',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 3].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
axes[1, 3].xaxis.set_major_locator(MaxNLocator(nbins=3))
...
axes[0, 4].plot(filter_fun_train[:,2], filter_fun_train[:,3], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[0, 4].set_title('S-G Filter', fontsize=34)
axes[0, 4].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
...
axes[1, 4].plot(filter_deri_train[:,2], filter_deri_train[:,3], linewidth=2, color = 'red',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
#plt.ylabel(r'Function $x$', fontsize=22)
#plt.legend(fontsize=24)
axes[1, 4].tick_params(axis='both', labelsize=24) # 调整 x 轴刻度字体大小
axes[1, 4].xaxis.set_major_locator(MaxNLocator(nbins=3))
