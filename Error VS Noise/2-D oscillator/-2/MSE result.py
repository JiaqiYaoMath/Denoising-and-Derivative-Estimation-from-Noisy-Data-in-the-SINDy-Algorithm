...
plt.plot(param_set.ts[:index], u_scaled[:index,0], linewidth=2, color = 'darkblue',linestyle='--', marker='o', markersize = 5, label = r'$x_1$')
plt.plot(param_set.ts[:index], u_scaled[:index,1], linewidth=2, color = 'green',linestyle='--', marker='o', label = r'$x_2$')
...
plt.style.use('seaborn-v0_8-whitegrid')
plt.figure(figsize=(8, 6))
plt.plot(param_set.ts[:index], deri_data[:index,0], linewidth=2, color = 'darkblue',linestyle='--', marker='o', label = r'$\dot{x}_1$')
plt.plot(param_set.ts[:index], deri_data[:index,1], linewidth=2, color = 'green',linestyle='--', marker='o', label = r'$\dot{x}_2$')
plt.xlabel(r'$t$', fontsize=30)
#plt.ylabel(r'Function $x$', fontsize=22)
...
plt.style.use('seaborn-v0_8-whitegrid')
plt.figure(figsize=(8, 6))
plt.plot(param_set.ts[:index], sec_data[:index,0], linewidth=2, color = 'darkblue',linestyle='--', marker='o', label = r'$\ddot{x}_1$')
plt.plot(param_set.ts[:index], sec_data[:index,1], linewidth=2, color = 'green',linestyle='--', marker='o', label = r'$\ddot{x}_2$')
plt.xlabel(r'$t$', fontsize=30)
#plt.ylabel(r'Function $x$', fontsize=22)
plt.legend(fontsize=24)
plt.xticks(fontsize=30)  # 调整 x 轴刻度字体大小
...
plt.plot(param_set.ts[:index], TVR_fun_train[:,0], linewidth=2,linestyle='-',color = 'black', label = r'TVR')
...
plt.tight_layout()
plt.savefig('figure/2x1.pdf', format='pdf')
plt.show()
...
plt.plot(param_set.ts[:index], torch.abs(train_output[:,0] - TVR_fun_train[:,0]), linewidth=2,linestyle='-',color = 'black', label = r'TVR')
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2x1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2x2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2x2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2dotx1.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2dotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2dotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2dotx2diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2ddotx1.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2ddotx1diff.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2ddotx2.pdf', format='pdf')
plt.show()
...
plt.yticks(fontsize=24)  # 调整 y 轴刻度字体大小
plt.tight_layout()
plt.savefig('figure/2ddotx2diff.pdf', format='pdf')
plt.show()
