...
filter_fun_train = savgol_filter(train_output, window_length=10, polyorder=9, axis=0)
filter_deri_train = savgol_filter(train_output, window_length=4, polyorder=3, deriv=1, axis=0)/param_set.sample_density

filter_fun_test = savgol_filter(test_output, window_length=10, polyorder=9, axis=0)
